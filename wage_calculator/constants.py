...
# ── 업무상 재해 인정 기준 (산재보험법 제37조, 뇌심혈관 질환 인정기준) ──────────
CEREBROVASCULAR_WEEKLY_HOURS_ACUTE  = 60   # 뇌심혈관 질환: 주 60시간 이상 → 산재 인정
CEREBROVASCULAR_WEEKLY_HOURS_CAUTION = 52  # 주 52시간 초과 + 가중요인 → 산재 인정 추세
CEREBROVASCULAR_OBSERVATION_WEEKS = 12     # 발병 전 관찰 기간 (12주)

# 12대 중과실 사고 (교통사고처리 특례법) — 산재 불인정 사유
TRAFFIC_GROSS_NEGLIGENCE = [
    "신호지시 위반", "중앙선 침범", "제한속도 20km 이상 초과",
    "앞지르기 방법·금지구간·시기 위반", "건널목 통과방법 위반",
    "횡단보도 보행자 보호의무 위반", "무면허 운전",
    "음주운전", "보도 침범·보도 횡단 방법 위반",
    "승객 추락 방지의무 위반", "어린이 보호구역 안전의무 위반",
    "적재물 추락 방지의무 위반",
]

# 특수고용직 산업안전보건법 적용 직종 (13개)
PLATFORM_SAFETY_OCCUPATIONS = [
    "보험설계사", "건설기계 운전자", "학습지 교사", "골프장 캐디",
    "택배기사", "퀵서비스 기사", "대리운전 기사", "화물차주",
    "배달기사", "방문판매원", "대출모집인", "신용카드모집인",
    "방과후교사",
]

# 특수고용직 해당 직종 (산재보험법 시행령 제125조, 고용보험법 시행령 제104조의11)
PLATFORM_WORKER_OCCUPATIONS = [
    "보험설계사", "건설기계 운전자", "학습지 방문교사", "골프장 캐디",
    "택배 운송기사", "배송 종사자", "대출 모집인", "신용카드 회원모집인",
    "대리운전 기사", "방문판매원", "대여제품 방문점검원", "가전제품 설치기사",
    "화물차주", "퀵서비스 기사", "소프트웨어 기술자", "관광안내원",
    "어린이 통학버스 운전사",
]

# 노동조합법상 근로자 판단 기준 6요소 (대법원 판례)
UNION_WORKER_CRITERIA = [
    "① 소득이 특정 사업주에게 경제적으로 의존하는지",
    "② 계약 내용이 사업자에 의해 일방적으로 결정되는지",
    "③ 특정 사업자의 사업 수행에 필수적인 노무를 제공하여 시장에 접근하는지",
    "④ 법률관계가 상당한 정도로 지속적·전속적인지",
    "⑤ 사업자의 지휘·감독 관계가 존재하는지",
    "⑥ 수입이 주로 노무 제공의 대가인지",
]
