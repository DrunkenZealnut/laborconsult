#!/usr/bin/env python3
"""
노동OK BEST Q&A 2025년 게시글 → Pinecone 벡터 업로드
...
사용법:
  python3 pinecone_upload_2025.py              # 전체 업로드
  python3 pinecone_upload_2025.py --reset      # 인덱스 초기화 후 재업로드
  python3 pinecone_upload_2025.py --pending    # pending 상태만 업로드
"""
...
def main():
    parser = argparse.ArgumentParser(description="Pinecone 2025 업로드")
